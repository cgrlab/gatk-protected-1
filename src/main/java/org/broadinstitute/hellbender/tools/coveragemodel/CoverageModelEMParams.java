...
/**
 * Parameters for {@link CoverageModelEMAlgorithm}. Works both as an ArgumentCollection, and a getter/setter class.
 *
...
public class CoverageModelEMParams {
    ...
    public enum SparkCommunicationPolicy {
        BROADCAST_HASH_JOIN,
        RDD_JOIN
    }

    public static final DataBuffer.Type DEFAULT_D_TYPE = DataBuffer.Type.DOUBLE;
    public static final String D_TYPE_SHORT_NAME = "DT";
    public static final String D_TYPE_LONG_NAME = "dType";
    ...
    public static final int DEFAULT_NUM_LATENTS = 2;
    ...
    public static final String W_SOLVER_TYPE_LONG_NAME = "wSolverType";

    public static final SparkCommunicationPolicy DEFAULT_W_COMMUNICATION_POLICY = SparkCommunicationPolicy.RDD_JOIN;
    ...
    public static final String MODEL_CHECKPOINTING_INTERVAL_LONG_NAME = "modelCheckpointingInterval";

    public static final boolean DEFAULT_MODEL_CHECKPOINTING_ENABLED = true;
    public static final String MODEL_CHECKPOINTING_ENABLED_SHORT_NAME = "MCP";
    public static final String MODEL_CHECKPOINTING_ENABLED_LONG_NAME = "modelCheckpointing";

    public static final String DEFAULT_MODEL_CHECKPOINTING_PATH = "/dev/null";
    ...
    @Argument(
            doc = "Nd4j data type",
            shortName = D_TYPE_SHORT_NAME,
            fullName = D_TYPE_LONG_NAME,
            optional = true
    )    protected DataBuffer.Type dType = DEFAULT_D_TYPE;
    ...
    protected PsiSolverMode psiSolverMode = DEFAULT_PSI_SOLVER_MODE;
    ...
    protected WSolverType wSolverType = DEFAULT_W_SOLVER_TYPE;
    ...
    @Argument(
            ...
            shortName = MODEL_CHECKPOINTING_INTERVAL_SHORT_NAME,
            fullName = MODEL_CHECKPOINTING_INTERVAL_LONG_NAME,
            optional = true
    )
    protected int modelCheckpointingInterval = DEFAULT_MODEL_CHECKPOINTING_INTERVAL;
    ...
    @Argument(
            ...
            shortName = MODEL_CHECKPOINTING_ENABLED_SHORT_NAME,
            fullName = MODEL_CHECKPOINTING_ENABLED_LONG_NAME,
            optional = true
    )
    protected boolean modelCheckpointingEnabled = DEFAULT_MODEL_CHECKPOINTING_ENABLED;
    ...
    @Argument(
            ...
            shortName = MODEL_CHECKPOINTING_PATH_SHORT_NAME,
            fullName = MODEL_CHECKPOINTING_PATH_LONG_NAME,
            optional = true
    )
    protected String modelCheckpointingPath = DEFAULT_MODEL_CHECKPOINTING_PATH;
    ...
    public CoverageModelEMParams setPsiPsiolverType(@Nonnull final PsiSolverMode psiSolverMode) {
        this.psiSolverMode = Utils.nonNull(psiSolverMode, "Psi solver mode must be non-null");
        return this;
    }
    ...
    public CoverageModelEMParams setWSolverType(@Nonnull final WSolverType wSolverType) {
        this.wSolverType = Utils.nonNull(wSolverType, "W solver type must be non-null");
        return this;
    }
    ...
    public CoverageModelEMParams setDType(@Nonnull final DataBuffer.Type dType) {
        this.dType = Utils.nonNull(dType, "The data type must be non-null");
        return this;
    }
    ...
    public SparkCommunicationPolicy getPrincipalMapSparkCommunicationPolicy() {
        return principalMapSparkCommunicationPolicy;
    }

    public CoverageModelEMParams setPrincipalMapSparkCommunicationPolicy(final SparkCommunicationPolicy principalMapSparkCommunicationPolicy) {
        this.principalMapSparkCommunicationPolicy = Utils.nonNull(principalMapSparkCommunicationPolicy);
        return this;
    }
    ...
    public int getModelCheckpointingInterval() {
        return modelCheckpointingInterval;
    }

    public CoverageModelEMParams setModelCheckpointingInterval(final int modelCheckpointingInterval) {
        this.modelCheckpointingInterval = ParamUtils.inRange(modelCheckpointingInterval, 1, Integer.MAX_VALUE,
    ...
    public CoverageModelEMParams disableModelCheckpointing() {
        modelCheckpointingEnabled = false;
        return this;
    }

    public boolean isModelCheckpointingEnabled() {
        return modelCheckpointingEnabled;
    }

    public String getModelCheckpointingPath() {
        return modelCheckpointingPath;
    }

    public CoverageModelEMParams setModelCheckpointingPath(final String modelCheckpointingPath) {
        this.modelCheckpointingPath = Utils.nonNull(modelCheckpointingPath, "Model checkpointing path must be non-null");
        return this;
    }
