 ...
 */
public class CoverageModelWLinearOperatorNDArrayLocal extends GeneralLinearOperator<INDArray> {
    ...
    public CoverageModelWLinearOperatorNDArrayLocal(@Nonnull final INDArray Q_tll,
