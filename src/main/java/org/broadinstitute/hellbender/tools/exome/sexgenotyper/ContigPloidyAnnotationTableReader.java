...
public final class ContigPloidyAnnotationTableReader extends TableReader<ContigPloidyAnnotation> {
    ...
    protected ContigPloidyAnnotation createRecord(@Nonnull final DataLine dataLine) {
        ...
        try {
            /* all lines must all ploidy annotations defined in the header */
    ...
    /**
     * Read contig ploidy annotations from file.
     *
     * @param contigPloidyAnnotationsFile a file
    ...
    /**
     * Read contig ploidy annotations from an abstract reader.
     *
