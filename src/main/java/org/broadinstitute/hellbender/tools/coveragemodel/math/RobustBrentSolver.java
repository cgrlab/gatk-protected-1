 ...
 */
public class RobustBrentSolver {
     ...
     */
    public double solve(final int maxEval, final UnivariateFunction objFunc,
        ...
        if (bracketsList.isEmpty()) {
            ...
            if (roots.isEmpty()) {
                ...
                if (meritFunc != null) {
                    ...
                    if (meritPolicy == null) {
                        throw new IllegalArgumentException("Either a merit function or a merit policy must be provided");
                    } else {
                        switch (meritPolicy) {
                            case SMALLEST_ROOT:
